...
Multi-agent variant of [`cascaded/omni-assistant`](../omni_assistant/README.md)
...
`src/cascaded/omni_assistant_subagents/`: pipeline entry point,
...
Host-native (no Docker), set `selection: cascaded/omni-assistant-subagents`
...
```python
from cascaded.omni_assistant_subagents.pipeline import bot
```

and never `from src.cascaded.omni_assistant_subagents ...`.
...
[`deploy/references/omni-assistant-subagents-deploy.md`](../../../.agents/skills/deploy/references/omni-assistant-subagents-deploy.md)
